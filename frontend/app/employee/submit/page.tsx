...
export default function LeaveRequestForm() {
  ...
  const isFormComplete = description && leaveType && startDate && endDate;
    ...
    <div className="min-h-screen bg-sky-50/50 flex items-start md:items-center justify-center p-4 md:p-8">
      <div className="w-full max-w-4xl">
        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
          ...
          {/* Summary - full width below both columns */}
          {totalDays !== null && totalDays > 0 && (
            ...
            <div className="flex flex-col-reverse sm:flex-row items-center gap-4 mt-8 pt-6 border-t border-gray-100">
              ...
              <button
                ...
                className={`w-full sm:w-auto px-12 py-3 rounded-full font-semibold text-sm tracking-wide transition-all shadow-md sm:ml-auto ${
                  isFormComplete
